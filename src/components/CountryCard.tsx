    ...
    >
      ...
      <div className="relative aspect-[3/2] w-full overflow-hidden bg-surface-dim">
        ...
        <div className="absolute bottom-2.5 right-3">
          <Image
            ...
            width={24}
            height={16}
            className="rounded-[2px] shadow-sm ring-1 ring-white/30"
            unoptimized
          />
        </div>
      ...
      <div className="flex items-center justify-between px-4 py-2.5">
        <span className="flex items-center gap-1.5 text-xs text-foreground/60">
          <svg className="h-3.5 w-3.5 shrink-0 text-foreground/40" viewBox="0 0 20 20" fill="currentColor">
            <path
              fillRule="evenodd"
